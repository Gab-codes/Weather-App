const apikey = "a5aa30b551f9900cc63d9a54b3788dfe";
...
async function getWeatherData(cityValue){
    try {
        ...
        weatherDataE1.querySelector(".description").textContent = "An error occured, please try again later";
